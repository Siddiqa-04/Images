...
const Description = () => {
  return (
	...
	viewport={{once: true}}
	>
		<h1 className="font-semibold mb-2 text-3xl sm:text-4xl">Create AI Images</h1>
		...
		<div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
			...
			<div>
				...
				<p className='text-gray-600 mb-4'>Simply type in a text prompt, and our cutting-edge AI will generate high-quality images in seconds. From product visuals to character designs and protraits, even concepts that don&apos;t yet exist can be visualised effeortlessly. Powered by advanced AI technology, the creative possibilities are limitless!</p>
			</div>
		</div>
	</motion.div>
  )
